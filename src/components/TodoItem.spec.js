...
describe('components', () => {
  describe('TodoItem', () => {
    ...
    it('input onChange should call editTodo', () => {
      const { output, props } = setup()
      const input = output.props.children.props.children[0]
      input.props.onChange({})
      expect(props.editTodo).toBeCalledWith(props.todo.id, { ...props.todo, completed: true })
    })
    ...
    it('TodoTextInput onSave should call editTodo', () => {
      ...
      expect(props.editTodo).toBeCalledWith(props.todo.id, { ...props.todo, text: 'Use Redux' })
    })
